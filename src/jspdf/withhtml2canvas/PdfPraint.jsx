...
export const PdfPaint = () => {
  ...
  return (
    <>
      ...
      <div className="container" id="newcontenet">
        ...
        <p>
          ...
          cupiditate iste. Neque deserunt eveniet minima voluptatem asperiores
          perspiciatis blanditiis, optio tenetur recusandae commodi quibusdam
          ullam omnis nihil corrupti. Maxime, necessitatibus minima. Accusantium
          earum nemo dolor ratione, quod minus possimus corporis?
        </p>
        <hr />
        <h1>
        ...
        <p>
          ...
          exercitationem fugit consectetur officia excepturi.
        </p>
      </div>
      <div id="content">
        {/* <link
        ...
        <div id="header">
          ...
          <a href="mailto:deepsukhwani@gmail.com" target="_blank">
            <p id="email">deepsukhwani@gmail.com</p>
          </a>
        </div>
        ...
        <div className="right">
          ...
          <p id="job-title">
            <strong>Support Engineer (Technical Support)</strong>
          </p>
          ...
          <ul>
            ...
            <li>
              Interact with our engineering team to get software issues and bugs
              resolved
            </li>
            <li>
          ...
          <ul>
            <li>
              <span id="course-name">Operating Systems:</span> DOS, Windows 98,
              Windows 2000, Windows XP, Windows NT, Windows Server 2003, Windows
              Vista, Windows 7, Macintosh Computers (OS X), Linux (Ubuntu,
              Fedora)
            </li>
            <li>
              <span id="course-name">Application Software:</span> Office
              97-2003; Office XP, Office 2007, Office for Mac 2011, iWork ’09,
              Sage Accounting Software, Sage 50 (Accounting Software), Excel
              2003/2007 for Financial Modelling spreadsheets.
            </li>
            <li>
              <span id="course-name">Programming Skills:</span>HTML, CSS,
              Python, JavaScript, learning C and C++
            </li>
          </ul>
          <p />
          ...
          <ul>
            <li>
              Scored highest in ACCA P1 – Governance, Risk &amp; Ethics exam –
              June 2012 session amongst full time international students at
